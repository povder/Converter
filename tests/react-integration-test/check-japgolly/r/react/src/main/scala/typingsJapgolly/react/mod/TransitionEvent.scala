...
object TransitionEvent {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[ReactTransitionEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class TransitionEventMutableBuilder[Self <: ReactTransitionEventFrom[Element], T] (val x: Self & (ReactTransitionEventFrom[T & Element])) extends AnyVal {
