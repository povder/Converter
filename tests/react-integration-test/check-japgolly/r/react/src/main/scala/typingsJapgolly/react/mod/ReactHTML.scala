...
object ReactHTML {
  ...
  implicit class ReactHTMLMutableBuilder[Self <: ReactHTML] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: DetailedHTMLFactory[DataHTMLAttributes[Element], Element]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDialog(value: DetailedHTMLFactory[DialogHTMLAttributes[Element], Element]): Self = StObject.set(x, "dialog", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTd(value: DetailedHTMLFactory[TdHTMLAttributes[Element], Element]): Self = StObject.set(x, "td", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTemplate(value: DetailedHTMLFactory[HTMLAttributes[Element], Element]): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTh(value: DetailedHTMLFactory[ThHTMLAttributes[Element], Element]): Self = StObject.set(x, "th", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWebview(value: DetailedHTMLFactory[WebViewHTMLAttributes[Element], Element]): Self = StObject.set(x, "webview", value.asInstanceOf[js.Any])
  }
}
