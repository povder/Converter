...
object WheelEvent {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[ReactWheelEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class WheelEventMutableBuilder[Self <: ReactWheelEventFrom[Element], T] (val x: Self & (ReactWheelEventFrom[T & Element])) extends AnyVal {
