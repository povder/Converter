...
object BaseSyntheticEvent {
  ...
  def apply[E, C, T](
    ...
    __obj.asInstanceOf[ReactEventFrom[C & Element]]
  }
  
  @scala.inline
  implicit class BaseSyntheticEventMutableBuilder[Self <: ReactEventFrom[Element], E, C, T] (val x: Self & (ReactEventFrom[C & Element])) extends AnyVal {
