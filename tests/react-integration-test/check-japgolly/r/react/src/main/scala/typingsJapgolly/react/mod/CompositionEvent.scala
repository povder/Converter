...
object CompositionEvent {
  ...
  def apply[T](
    ...
    timeStamp: Double,
    `type`: String
  ): ReactCompositionEventFrom[T & Element] = {
    ...
    __obj.asInstanceOf[ReactCompositionEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class CompositionEventMutableBuilder[Self <: ReactCompositionEventFrom[Element], T] (val x: Self & (ReactCompositionEventFrom[T & Element])) extends AnyVal {
