...
object DragEvent {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[ReactDragEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class DragEventMutableBuilder[Self <: ReactDragEventFrom[Element], T] (val x: Self & (ReactDragEventFrom[T & Element])) extends AnyVal {
