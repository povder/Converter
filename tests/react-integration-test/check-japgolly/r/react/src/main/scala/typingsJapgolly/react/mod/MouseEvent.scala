...
object MouseEvent {
  ...
  def apply[T, E](
    ...
    __obj.asInstanceOf[ReactMouseEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class MouseEventMutableBuilder[Self <: ReactMouseEventFrom[Element], T, E] (val x: Self & (ReactMouseEventFrom[T & Element])) extends AnyVal {
