...
object TouchEvent {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[ReactTouchEventFrom[T & Element]]
  }
  
  @scala.inline
  implicit class TouchEventMutableBuilder[Self <: ReactTouchEventFrom[Element], T] (val x: Self & (ReactTouchEventFrom[T & Element])) extends AnyVal {
