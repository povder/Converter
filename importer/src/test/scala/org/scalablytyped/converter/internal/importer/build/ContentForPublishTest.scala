  ...
  test("ivy") {
    ...
    xml.toString should be(
      ...
      <dependencies>
        ...
        <dependency org="org.scala-js" name="scalajs-compiler_2.13.3" rev="1.5.0" conf="plugin-&gt;default(compile)"/>
        <dependency org="org.scala-js" name="scalajs-library_2.13" rev="1.5.0" conf="compile-&gt;default(compile)"/>
        <dependency org="org.scala-js" name="scalajs-test-interface_2.13" rev="1.5.0" conf="test-&gt;default(compile)"/>
        <dependency org="com.olvind" name="scalablytyped-runtime_sjs1_2.13" rev="2.4.0" conf="compile-&gt;default(compile)"/>
