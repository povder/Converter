...
object Deps {
  ...
  val osLib             = "com.lihaoyi" %% "os-lib" % "0.7.2"
  val sourcecode        = "com.lihaoyi" %% "sourcecode" % "0.2.3"
  val scalatest         = "org.scalatest" %% "scalatest" % "3.2.3"
  val fansi             = "com.lihaoyi" %% "fansi" % "0.2.10"
  val bloop             = "ch.epfl.scala" %% "bloop-frontend" % "1.4.7"
